...
function compareVersions(version1, version2) {
  ...
  //找出更长的那个数组的长度
  const longerArr = version1Arr.length > version2Arr.length ? version1Arr : version2Arr
...
function delPreZero(version) {//消除前导0
  return version.split(".").map(i => Array.from(i).reduce((pre, cur) => {
    if (cur === '0' && pre === '') {
      return pre
    }
    if (cur !== '0' || pre !== '') {
